export default class GameScene extends Phaser.Scene {
    ...
    preload() {         
        ...
        this.load.audio('shootSound', 'assets/audio/fireball.wav');
        this.load.audio('collisionSound', 'assets/audio/explosion.wav');
        this.load.audio('playerSound', 'assets/audio/CharacterHit.wav');
    ...
    create() {
        ...
        this.player.body.setSize(80, 85);
        this.player.body.setOffset(85, 60);
    ...
    // spawn a new obstacle every .7 seconds
        ...
        this.physics.add.collider(this.projectiles, this.obstacles, (projectile, obstacle) => {
            ...
            this.sound.play('collisionSound', { volume: 2 });
        ...
        if (this.input.keyboard.checkDown(this.cursors.space, 300)) {
            ...
            this.sound.play('shootSound', { volume: 7 });
            }
...
spawnProjectile() {
    ...
    // Reduce the hitbox size of the projectile
    fireball.body.setSize(fireball.width - 40, fireball.height);
    fireball.body.setOffset(20, -10 );
